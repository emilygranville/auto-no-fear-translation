...
CKPT_DIR = "./code/ckpt/dictionary"

DICTIONARY_EMBED_DIR = "./data/dictionary-mappings/"
DICTIONARY_EMBED_FNAME = "pretrained_embeddings.txt"
...
class Seq2SeqTransformer(nn.Module):
    def __init__(self,
        ...
        self.src_tok_emb = SrcTokenEmbedding(src_vocab_size, emb_size)
...
3.  Tutorial on putting pretrained embeddings into a transformer 
    <https://github.com/pytorch/text/issues/722#issuecomment-609880042>
